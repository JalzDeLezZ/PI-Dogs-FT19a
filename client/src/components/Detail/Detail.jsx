    ...
    <div>
        {myBreed.length > 0 ?
         <div>
             ...
             <h4>Height [cm]: {myBreed[0].createdInDb? (myBreed[0].height_min + ' - ' + myBreed[0].height_max) : myBreed[0].height}</h4>  
             <h4>Weight [Kg]: {myBreed[0].createdInDb? (myBreed[0].weight_min + ' - ' + myBreed[0].weight_max) : myBreed[0].weight}</h4>
         </div> : <p>Loading...</p>
        }
        <Link to= '/home'>
